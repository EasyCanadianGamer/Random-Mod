...
public class ModItems
{
	...
	public static final ArmorMaterial ARMOR_MATERIAL_STONE = EnumHelper.addArmorMaterial("armor_material_stone", Reference.MOD_ID + ":stone", 50, new int[] {3,4,5,6} ,20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
